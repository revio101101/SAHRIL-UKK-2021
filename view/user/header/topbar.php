...
<?php $count = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM notifikasi WHERE nik='$data[nik]'")); ?>
          <!-- Topbar Navbar -->
...
<?php
  global $koneksi;
  $sql = mysqli_query($koneksi, "SELECT * FROM notifikasi WHERE nik='$data[nik]' ORDER BY id_notifikasi DESC LIMIT 4");
...
<?php } ?>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 animated--grow-in d-lg-inline text-gray-600 small"><i class="fas fa-user fa-fw mr-2 text-gray-400"></i> <?= $data['nama'];?></span>
              </a>
