...
<div style="position: absolute;top: 0;bottom: 0;left: 0;right: 0;background-color: darkblue ;opacity: 0.6;"></div>
  <div class="container">
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-7 d-none d-lg-block bg-login-image">
                <div style="position: absolute;top: 0;bottom: 0;left: 0;right: 0;background-color: blue ;opacity: 0.5;"></div>
                <div style="text-shadow: 0 40px 60px;" class="text-light animated--grow-in col-lg d-lg-block justify-content-center container p-5">
                  ...
                  <p>Desa Galanggang, Kecamatan Batujajar</p>
                </div>
              </div>
              <div class="col-lg-5">
                <div class="p-5">
